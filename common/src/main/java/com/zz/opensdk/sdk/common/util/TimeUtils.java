...
public class TimeUtils {
	...
	public static final String SMS_TIME_FORMAT = "dd-MM-yyyy HH:mm";
...
//		int repaymentDat = 28;
//		int yesterday = TimeUtils.getDay(TimeUtils.minusDays(new Date(),1));
//		System.out.println("yesterday="+yesterday);
//		System.out.println(repaymentDat==yesterday);
//		System.out.println(TimeUtils.formatDate(TimeUtils.getRepaymentDate(new Date(), 5)));
		System.out.println(TimeUtils.formatDate(TimeUtils.getCurDate()));
	}
