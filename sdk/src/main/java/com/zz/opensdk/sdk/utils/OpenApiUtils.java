...
import com.zz.opensdk.sdk.utils.json.JSONReader;
import com.zz.opensdk.sdk.utils.json.JSONValidatingReader;
...
public abstract class OpenApiUtils {
     ...
     * @return API响应对象
     */
//    public static <T extends ResponseBaseVo> T parseResponse(String json, Class<T> clazz)
