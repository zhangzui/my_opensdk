 ...
 * @date 2018/9/5 18:52
 */
public class MyModuleClassLoader2 extends URLClassLoader{

    public MyModuleClassLoader2(URL[] urls, ClassLoader parent) {
        super(urls);
    }
    ...
    protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
        Class<?> result = null;
        synchronized (MyModuleClassLoader2.class) {
